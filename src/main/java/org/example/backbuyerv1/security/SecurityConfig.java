    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(c-> c.disable())
                ...
                .authorizeHttpRequests(r -> r
                        .requestMatchers("/api/refink/buyer/register").permitAll()
                        .requestMatchers("/api/refink/buyer/login").permitAll()
                        .requestMatchers("/api/refink/buyer/home").authenticated()
